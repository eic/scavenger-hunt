...
> - How many entries are within the branch elements of `VertexBarrelHits` for this file? Take this number of entries divide it by five, round this value to the nearest integer. This is your answer for task 2!
> - As an equation: $$round(Entries/5)$$
