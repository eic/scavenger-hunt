...
Once you switch to this container version. Your task is to uncover which version of SOFTWARE PACKAGE was used in this release. The last two digits are your first clue!
...
For this task, download FILE from the CAMPAIGN. Find out how many events are in this file. 

The number of events in this file are your second clue!

# Task 3 - Differences Between Event Generators

Many event generators exist for a wide range of processes. In some cases, the same process can be simulated using two different versions of the same generator. The output of the two versions can differ. In this task, get an alternative version of the file from Task 2 that was produced using a different event generator. Grab FILE. Check QUANTITY in this file compared to the previous file. The difference between the mean value of QUANTITY from FILE1 and TASK2 FILE is your third clue!
